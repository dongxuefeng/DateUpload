...
/*
inline bool WriteWxErrorLog(char *strInfo, char * logdir = "./log/", char * file_mark = "WX_webservice_fail", char * log_mark = "Error")
{
	return WriteLog(strInfo, logdir, file_mark, log_mark);
}
*/
